...
func _on_Button1_pressed():
	if str(player_vars.rank)=="Godfather":
		aniplayer2.play("FADE5")
		yield(aniplayer2, "animation_finished")
		get_tree().change_scene("res://GodCombat.tscn")
		
	aniplayer2.play("FADE5")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LICombat.tscn")
	
	
func _on_Button2_pressed():
	aniplayer2.play("FADE5")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LI_UnderBoss.tscn")


func _on_Button3_pressed():
	aniplayer2.play("FADE5")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LI_Roulette.tscn")


func _on_Button4_pressed():
	aniplayer2.play("FADE5")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LI_Tailor.tscn")
...
func _on_Button5_pressed():
	...
	UndzerLbl.text="Undzer Shtick: "+str(player_vars.UndzerRep)
