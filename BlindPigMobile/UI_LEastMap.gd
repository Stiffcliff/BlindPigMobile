...
func _on_Button1_pressed():
	if str(player_vars.rank)=="Godfather":
		aniplayer2.play("FADE7")
		yield(aniplayer2, "animation_finished")
		get_tree().change_scene("res://GodCombat.tscn")
		
	aniplayer2.play("FADE7")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LECombat.tscn")
	
func _on_Button2_pressed():
	aniplayer2.play("FADE7")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LE_Marks.tscn")


func _on_Button3_pressed():
	aniplayer2.play("FADE7")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LE_Boxing.tscn")


func _on_Button4_pressed():
	aniplayer2.play("FADE7")
	yield(aniplayer2, "animation_finished")
	get_tree().change_scene("res://LE_Dealer.tscn")
